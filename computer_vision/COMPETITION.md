...
- **Simulation:** Use **`launch_cv_sim.py`** or **`launch_cv.py use_sim:=true`** when Gazebo bridges publish `/camera0/image_raw` etc. See [../src/asv_wave_sim/SIMULATION.md](../src/asv_wave_sim/SIMULATION.md).
