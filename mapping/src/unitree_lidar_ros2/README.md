...
This package lives in the **mapping** workspace. Build from the mapping folder (the C++ SDK is in `mapping/unilidar_sdk/unitree_lidar_sdk`):
...
To visualize the cloud in RViz2 (from mapping workspace after sourcing install):
```
