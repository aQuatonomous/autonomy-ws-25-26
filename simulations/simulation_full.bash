...
tmux new-session -d -s "$SESSION" \
  'source /opt/ros/humble/setup.bash && source ~/autonomy-ws-25-26/src/asv_wave_sim/install/setup.bash && export GZ_VERSION=harmonic && export LD_LIBRARY_PATH=/usr/lib/aarch64-linux-gnu/nvidia:$HOME/autonomy-ws-25-26/src/asv_wave_sim/install/lib:$LD_LIBRARY_PATH && export GZ_SIM_SYSTEM_PLUGIN_PATH=$HOME/ardupilot_gazebo/build:${GZ_SIM_SYSTEM_PLUGIN_PATH:-} && export GZ_SIM_RESOURCE_PATH=$HOME/SITL_Models/Gazebo/models:$HOME/SITL_Models/Gazebo/worlds:$HOME/ardupilot_gazebo/models:$HOME/ardupilot_gazebo/worlds:${GZ_SIM_RESOURCE_PATH:-} && cd ~/autonomy-ws-25-26/src/asv_wave_sim/gz-waves-models/worlds && gz sim -v 4 -r super_cool_test.sdf'
