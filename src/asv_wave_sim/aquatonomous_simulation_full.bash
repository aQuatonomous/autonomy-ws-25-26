...
tmux split-window -t "${SESSION}:0" -h 'source /opt/ros/jazzy/setup.bash && source ~/bridge_ws/install/setup.bash && sleep 20 && ros2 run ros_gz_bridge parameter_bridge /lidar_topic/points@sensor_msgs/msg/PointCloud2@gz.msgs.PointCloudPacked --ros-args -r /lidar_topic/points:=/laser_points'
tmux split-window -t "${SESSION}:0.1" 'source /opt/ros/jazzy/setup.bash && source ~/bridge_ws/install/setup.bash && sleep 20 && ros2 run ros_gz_bridge parameter_bridge /camera1_topic@sensor_msgs/msg/Image@gz.msgs.Image --ros-args -r /camera1_topic:=/camera0/image_raw'
tmux split-window -t "${SESSION}:0.2" 'source /opt/ros/jazzy/setup.bash && source ~/bridge_ws/install/setup.bash && sleep 20 && ros2 run ros_gz_bridge parameter_bridge /camera2_topic@sensor_msgs/msg/Image@gz.msgs.Image --ros-args -r /camera2_topic:=/camera1/image_raw'
tmux split-window -t "${SESSION}:0.3" 'source /opt/ros/jazzy/setup.bash && source ~/bridge_ws/install/setup.bash && sleep 20 && ros2 run ros_gz_bridge parameter_bridge /camera3_topic@sensor_msgs/msg/Image@gz.msgs.Image --ros-args -r /camera3_topic:=/camera2/image_raw'
