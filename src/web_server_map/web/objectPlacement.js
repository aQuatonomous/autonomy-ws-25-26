...
class ObjectPlacement {
    ...
    setupUI() {
        // Create and add the placement mode toggle button inside #status
        ...
        // Create the object toolbar and insert it below the header in normal flow
        ...
        mainContainer.insertBefore(toolbar, header.nextSibling);
